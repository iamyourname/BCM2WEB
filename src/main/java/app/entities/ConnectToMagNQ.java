...
public class ConnectToMagNQ {
    ...
    public  String getBacInfo(String buf, String sap) throws SQLException {
        String response="";
        ...
        String sqlQueryBacchus="SELECT * FROM\n" +
              ...
              //  "    AND ba.DATA > SYSDATE - 10\n" +
                "    AND (\n" +
                "                ( ba.BUF = '"+buf+"'    OR ba.BUF = '"+bccbuf+"' )\n" +
                "            OR  ( ba.TTN = '"+buf+"'    OR ba.TTN = '"+bccbuf+"' )\n" +
                "            OR  ( ba.SAP = '"+buf+"'    OR ba.SAP = '"+bccbuf+"' ) \n" +
                "        )";
