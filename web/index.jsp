...
<div  class ="w3-light-gray w3-center">
	...
	<div style="border-top-left-radius:  25px; border-top-right-radius:  25px;" class=" w3-light-blue  w3-padding">
        ...
        <h4 align="right">!!!TEST!!! last deploy <% File fl = new File("E:\\Progs\\TomCat_9\\webapps\\test.war");
        out.println(fl.lastModified()); %>Привет <% out.println(NTLMUserFilter.getUserName()); %>!</h4>
