...
<div id="Tokyo" class="city" style="display:none">
    ...
    <div id = "CaduSearch" name = "mainIfo" class="SystemAction w3-panel w3-light-gray w3-display-container w3-card-4 " style = "display: none">
        <div class=" w3-light-blue">
            <h4 >Кадуцей</h4>
        </div>
        <!--method="GET" action="" target = "my_frame" -->
    ...
    <div id = "CaduCheck" name = "mainIfo" class="SystemAction w3-panel w3-light-gray w3-display-container w3-card-4 " style = "display: none">
        ...
        <form  class = "auth-info"  >
            ...
            <label>Сертификаты:
                <input onclick="document.getElementById('id777').style.display='block'" id="ccert" type="button" value="Добавить" class="w3-btn w3-green w3-round-large" style="width: 100%">
